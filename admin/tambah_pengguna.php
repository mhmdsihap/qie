...
$outlet = mysqli_query($conn, "SELECT * FROM tbl_m_outlet");
if (isset($_POST['btn-simpan'])) {
    ...
    $query = "INSERT INTO tbl_m_user (nama_user, username, password, role, outlet_id) values ('$nama', '$username', '$password', '$role', '$id_outlet')";
