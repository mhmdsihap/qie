...
$id = $_GET['id'];
$query = "SELECT * FROM tbl_m_paket_cuci WHERE id_paket = '$id'";
...
if (isset($_POST['btn-simpan'])) {
    ...
    $query = "UPDATE tbl_m_paket_cuci SET nama_paket = '$nama', jenis_paket = '$jenis', harga = '$harga', outlet_id = '$id_outlet' WHERE id_paket = '$id'";
                        ...
                        <form action="" method="POST">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    $query2 = "SELECT * FROM tbl_m_outlet";
