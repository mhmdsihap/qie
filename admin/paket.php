...
$query = "SELECT tbl_m_outlet.nama_outlet, tbl_m_paket_cuci.* FROM tbl_m_paket_cuci INNER JOIN tbl_m_outlet ON tbl_m_paket_cuci.outlet_id = tbl_m_outlet.id_outlet";
