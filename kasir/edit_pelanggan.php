...
$id = $_GET['id'];
$query = "SELECT * FROM tbl_m_pelanggan WHERE id_pelanggan = $id";
...
if (isset($_POST['btn-simpan'])) {
    ...
    $query = "UPDATE tbl_m_pelanggan SET nama_pelanggan = '$nama', alamat_pelanggan = '$alamat', no_ktp = '$no_ktp', telp_pelanggan = '$telp', jenis_kelamin = '$jenis_kelamin' WHERE id_pelanggan = $id";
